...
const TankVisualization = dynamic(() => import('@/components/visualization/TankVisualization'), {
  ssr: false,
  loading: () => (
...
const PumpVisualization = dynamic(() => import('@/components/visualization/PumpVisualization'), {
  ssr: false,
  loading: () => (
    <div className="flex items-center justify-center h-full">
      펌프 3D 모델 로딩 중...
  ...
  const handleCalculate = () => {
    ...
    try {
      ...
      if (selectedCalculator === 'tank') {
        calculationResult = calculateTankVolume({
        ...
        calculationResult = calculateNPSH({
        ...
        calculationResult = calculateAffinity({
